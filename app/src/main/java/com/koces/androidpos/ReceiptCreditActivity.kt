...
class ReceiptCreditActivity : BaseActivity() {
    val TAG:String = ReceiptCreditActivity::class.java.simpleName
    ...
    lateinit var mLinearCredit:LinearLayout
    ...
    fun initRes(idx:String) {
        ...
        mTvwStoreNm = findViewById(R.id.receiptcredit_txt_storenm)
        ...
        mTvwBusineNumber = findViewById(R.id.receiptcredit_txt_businesenumber)
        ...
        mTvwTID = findViewById(R.id.receiptcredit_txt_tid)
        mTvwTID.text =  "***" +  TID.substring(3)
        mTvwOwner = findViewById(R.id.receiptcredit_txt_owner)
        ...
        mTvwPhone = findViewById(R.id.receiptcredit_txt_phone)
        ...
        mTvwAddr = findViewById(R.id.receiptcredit_txt_addr)
        ...
        mTvwNo = findViewById(R.id.receiptcredit_txt_no)
        mTvwNo.text = mData.getid().toString()
        mTvwAuDate = findViewById(R.id.receiptcredit_txt_date)
        mTvwAuDate.text = parsingDate(mData.auDate)
        mTvwAuNum = findViewById(R.id.receiptcredit_txt_authno)
        mTvwAuNum.text = mData.auNum
        mTvwAcquirer = findViewById(R.id.receiptcredit_txt_Acquirer)
        mTvwAcquirer.text = mData.cardInpNm
        mTvwIssuer = findViewById(R.id.receiptcredit_txt_issuer)
        mTvwIssuer.text = mData.cardIssuer
        mTvwCardNum = findViewById(R.id.receiptcredit_txt_cardnum)
        mTvwCardNum.text = mData.cardNum
        mTvwCardKind = findViewById(R.id.receiptcredit_txt_cardkind)
        when(mData.cardType){
            "1" -> {
        ...
        mInstallment = findViewById(R.id.receiptcredit_txt_inst)
        var _inst = ""
        _inst = mData.inst + " 개월"
        if(mData.inst == "" || mData.inst == "0")
            _inst = "일시불"
        mInstallment.text = _inst
        mTvwMsg = findViewById(R.id.receiptcredit_txt_msg)
        mTvwMsg.text = mData.message

        /** 금액설정 */
        mTvwMoney = findViewById(R.id.receiptcredit_txt_orimoney)
        //공급가액
        ...
        mTvwMoney.text = Utils.PrintMoney(correctMoney.toString()) + "원"
        mTvwVat = findViewById(R.id.receiptcredit_txt_vat)
        mTvwVat.text = Utils.PrintMoney(mData.tax) + "원"
        mTvwSvc = findViewById(R.id.receiptcredit_txt_svc)
        mTvwSvc.text = Utils.PrintMoney(mData.svc) + "원"
        mTvwTxf = findViewById(R.id.receiptcredit_txt_txf)
        mTvwTxf.text = Utils.PrintMoney(mData.txf) + "원"
        mTvwTotalMoney = findViewById(R.id.receiptcredit_txt_totalmoney)
        ...
        mLinearSvc = findViewById(R.id.receiptcredit_linear_svc)
        mLinearTxf = findViewById(R.id.receiptcredit_linear_txf)
        ...
        /** 영수증화면 전체레이아웃 */
        mLinearCredit = findViewById(R.id.receiptcredit)

        /** 프린터 영수증 */
        mBtnPrint = findViewById(R.id.receiptcredit_btn_print)
        mBtnPrint.setOnClickListener {
            Print_Receipt()
        }

        /** 이미지 저장 */
        mBtnImageSave = findViewById(R.id.receiptcredit_btn_imagesave)
        mBtnImageSave.setOnClickListener {
            imgSaveOnClick()
        }

        /** 결제 취소 버튼 */
        mLinearCancel = findViewById(R.id.receiptcredit_linear_cancel)
        mBtnCancel = findViewById(R.id.receiptcredit_btn_cancel)
        if (mValue == "last")
        {
            mBtnCancel.text = "확인"
        }
...
//            mLinearCancel.visibility = View.GONE
        ...
        mBtnCancel.setOnClickListener {
            ...
            if (mValue == "last")
            {
                val intent = Intent(this@ReceiptCreditActivity, Main2Activity::class.java) // for tabslayout
//                intent.flags =
...
//                ReadyDialogHide()
        ...
        //하단 버튼 처리
        //어플 최소화
        val btnMinimum = findViewById<Button>(R.id.receiptcredit_btn_home)
...
//                Intent.FLAG_ACTIVITY_CLEAR_TOP
        ...
        //가맹점등록
        val btnStoreInfo = findViewById<Button>(R.id.receiptcredit_btn_store_info)
        btnStoreInfo.setOnClickListener {

            val intent = Intent(this@ReceiptCreditActivity, StoreMenuActivity::class.java) // for tabslayout
//            intent.flags =
//                Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK or Intent.FLAG_ACTIVITY_CLEAR_TOP
//            intent.flags =
//                Intent.FLAG_ACTIVITY_CLEAR_TOP
        ...
        //환경설정이동
        val btnEnvironment = findViewById<Button>(R.id.receiptcredit_btn_setting);
        btnEnvironment.setOnClickListener {
            val intent = Intent(this@ReceiptCreditActivity, menu2Activity::class.java)
//            intent.flags =
//                Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK or Intent.FLAG_ACTIVITY_CLEAR_TOP
//            intent.flags =
//                Intent.FLAG_ACTIVITY_CLEAR_TOP
    ...
    fun CancelCredit(){
        ...
        val intent: Intent = Intent(this@ReceiptCreditActivity, CreditLoadingActivity::class.java)
...
//        intent.putExtra("TrdCode", "")                          //거래구분(T:거래고유키취소, C:해외은련, A:App카드결제 U:BC(은련) 또는 QR결제 (일반신용일경우 미설정)
        intent.putExtra("TradeNo", mData.tradeNo)                          //Koces거래고유번호(거래고유키 취소 시 사용)
...
//        Utils.printAlertBox(Title: "프린트 출력중입니다", LoadingBar: true, GetButton: "")
        ...
        //카드번호
        printParser(Utils.PrintPad( "카드번호",  mTvwCardNum.text.toString()) + Constants.PENTER)
        //승인번호
...
//                    val b1 = ByteArray(text.size + 3)
//                    System.arraycopy(text, 0, b1, 3, text.size)
//                    b1[0] = 0x1B.toByte()
//                    b1[1] = 0x21.toByte()
//                    b1[2] = 0x02.toByte()
    ...
    private fun drawBitmap(): Bitmap {
        //기기 해상도를 가져옴.
        mLinearCredit.buildDrawingCache() //캐시 비트 맵 만들기
        val bitmap = mLinearCredit.drawingCache
